...
async def upload_chunk_handler(request):
    try:
        ...
        storage_endpoint="https://st66p62rgpyqnki.blob.core.windows.net" #os.environ["AZURE_STORAGE_ENDPOINT"]#
        storage_container="content" #os.environ["AZURE_STORAGE_CONTAINER"]#
        az_tenant_id="94e6b5f2-d1da-4de9-a4ca-88cfdb6c3de0" #os.environ["AZURE_TENANT_ID"]#

        credential = get_azure_credential()
        token = credential.get_token("https://storage.azure.com/.default")
        print("✅ Managed Identity token acquired:", token.token[:20], "...")
...
async def fetch_files_handler(request):
    try:
        storage_endpoint = "https://st66p62rgpyqnki.blob.core.windows.net"  # Replace with your Azure Blob Storage endpoint
        storage_container = "content"  # Replace with your container name
...
async def reindex_handler(request):
    try:
        # Use environment variables for indexer and endpoints
        storage_endpoint = "https://st66p62rgpyqnki.blob.core.windows.net"
